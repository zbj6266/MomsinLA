...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__info_detail__ = __webpack_require__(295);
...
var InfoDetailPageModule = /** @class */ (function () {
    ...
    InfoDetailPageModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["I" /* NgModule */])({
            ...
            imports: [
                __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["e" /* IonicPageModule */].forChild(__WEBPACK_IMPORTED_MODULE_2__info_detail__["a" /* InfoDetailPage */]),
            ],
        })
...
var InfoDetailPage = /** @class */ (function () {
    ...
    InfoDetailPage.prototype.ionViewDidLoad = function () {
        ...
        tim.X(this.table).Get({ query: { _id: this.infoId } }).then(function (data) {
            _this.disp = data.data[0];
