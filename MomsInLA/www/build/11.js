...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__activitylist__ = __webpack_require__(539);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__ionic_native_native_geocoder__ = __webpack_require__(307);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__components_activity_filter_activity_filter__ = __webpack_require__(308);
...
var ActivitylistPage = /** @class */ (function () {
    function ActivitylistPage(navCtrl, navParams, fsp, geocoder, popoverCtrl, geolocation, timeFormat, events, toast) {
        ...
        this.events.subscribe('distance', function () {
            if (_this.isLoaded && _this.isLocated) {
                for (var i = 0; i < _this.allData.length; i++) {
                    if (!_this.allData[i]['calDistance']) {
                        _this.calDistance({ lng: _this.longitude, lat: _this.latitude }, _this.allData[i]['address'], i);
                    }
                }
            }
        });
    ...
    ActivitylistPage.prototype.loadAllData = function () {
        var _this = this;
        __WEBPACK_IMPORTED_MODULE_7_firebase_app___default.a.database().ref('/DailyEvents/').orderByChild('activityApproved').equalTo(true).once('value').then(function (snapshot) {
    ...
    ActivitylistPage.prototype.openLibrary = function () {
    ...
    ActivitylistPage.prototype.calDistance = function (o, d, index) {
        ...
        function callback(response, status) {
            ...
            if (response.rows[0]['elements'][0]['status'] == "OK") {
                ...
                var dom = document.getElementsByClassName('distant').item(index);
                if (dom != null)
