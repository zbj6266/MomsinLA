...
var ToastProvider = /** @class */ (function () {
    ...
    ToastProvider.prototype.presentPrompt = function (key, usr) {
        var _this = this;
        var alert = this.alertCtrl.create({
            ...
            buttons: [
                ...
                },
                {
                    text: '提交',
                    handler: function (data) {
                        _this.events.publish('activity_reply', key, data);
                    }
                }
            ]
        });
