...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__activitylist__ = __webpack_require__(521);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__ionic_native_native_geocoder__ = __webpack_require__(295);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__components_activity_filter_activity_filter__ = __webpack_require__(296);
...
var ActivitylistPage = /** @class */ (function () {
    ...
    // }
    function ActivitylistPage(navCtrl, navParams, fsp, geocoder, popoverCtrl) {
    ...
    ActivitylistPage.prototype.loadData = function () {
        this.disp$ = this.fsp.getDailyEvent().snapshotChanges().pipe(Object(__WEBPACK_IMPORTED_MODULE_3_rxjs_operators__["map"])(function (changes) {
    ...
    ActivitylistPage.prototype.presentPopover = function (event) {
        ...
        popover.onDidDismiss(function (data) {
            _this.disp$ = _this.fsp.getDailyEventInOrder(data.idx).snapshotChanges().pipe(Object(__WEBPACK_IMPORTED_MODULE_3_rxjs_operators__["map"])(function (changes) {
                return changes.map(function (c) { return (__assign({ key: c.payload.key }, c.payload.val())); });
            }));
        });
    };
